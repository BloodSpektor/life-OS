    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            {isAuthenticated ? `Добро пожаловать, ${userName}!` : "Добро пожаловать!"}
          </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {dailyStats.steps.count.toLocaleString('ru-RU')}
            </div>
            <p className="text-xs text-gray-500 mt-1">
              из {dailyStats.steps.target.toLocaleString('ru-RU')}
            </p>
            <Progress
                  ...
                  <div key={notification.id} className="flex items-center justify-between border rounded-lg p-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleDeleteMeal(notification.id)}
                      >
